"""
Datenbank-Manager für Guild-Konfigurationsverwaltung und andere DB-Operationen.
"""
...
from .models import Birthday, CommandStatistic, GuildConfig, MemoryTiming, Specification
